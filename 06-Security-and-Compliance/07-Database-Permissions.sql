...
Purpose: Reports explicit database and object permissions in the current database.
...
ORDER BY grantee.name, perm.class_desc, SecurableName, perm.permission_name;
